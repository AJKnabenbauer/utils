...
#define log_errorString(userMsg) logError ( __TIMESTAMP__, __FILE__, __FUNCSIG__, __LINE__, userMsg )
#define log_error() log_errorString("UNOWN ERROR")
#define log_assert(expression) if (!(expression)) logError ( __TIMESTAMP__, __FILE__, __FUNCSIG__, __LINE__, "Assert Failed: " #expression)
